...
?>
<input class="hidden <?= $this->field->inputTarget ?>" <?= $this->field->inputArgs(); ?> name="<?= $this->field->id; ?>" id="<?= $this->field->inputTarget; ?>" value="<?= $this->metaValue; ?>"/>

<div class="<?= $this->field->previewTarget; ?>">
    <img height="100" src="<?= wp_get_attachment_image_url($this->getMetaValue(), 'medium'); ?>">
</div>
